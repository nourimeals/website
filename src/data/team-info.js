module.exports = {
  ...
  cody: {
    ...
    bio: 'I am a stay at home dad and software developer. I love to make things that are easy to use and make peoples lives easier. I have been with Nouri from the start and believe that we can be a positive influence for helping food insecure children.',
  },
  ryan: {
    name: 'Ryan Johnson',
